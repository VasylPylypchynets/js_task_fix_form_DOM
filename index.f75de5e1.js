...
function splitCamelCase(str) {
    let string = str;
    if (string.charAt(0).toUpperCase() === string.charAt(0)) string = " " + string;
...
fieldText.forEach((input)=>{
    ...
    const nameInput = input.getAttribute(InputName) ? splitCamelCase(input.getAttribute(InputName)) : null;
